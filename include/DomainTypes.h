...
class DurationUnits final {
    int units;
public:
    explicit constexpr DurationUnits(const int units) noexcept : units(units) {}
...
/**
 * @brief Strong type for resource capacity and depletion units.
 */
